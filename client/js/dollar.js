...
//
    ...
    exports.DollarRecognizer = function () // constructor
    {
        //
        ...
        this.AddTemplate = function (name, points) {
            ...
            for (var i = 0; i < this.Templates.length; i++) {
                if (this.Templates[i].Name == name) {
                    this.Templates[i] = new Template(name, points);
                    return;
                }
            }
